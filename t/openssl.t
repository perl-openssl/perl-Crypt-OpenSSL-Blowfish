...
is(ref $cipher, 'Crypt::OpenSSL::Blowfish');
...
my $decrypted_openssl = `echo -n $encrypted | openssl enc -nopad -d -bf-ecb -K '30313233303132333031323330313233' -provider legacy -provider default`;
ok ($decrypted_openssl eq "Hello!!!", "properly decrypted with openssl");
